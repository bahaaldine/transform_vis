import echarts from 'plugins/transform_vis/../node_modules/echarts/dist/echarts.min.js';
...
.directive('compile', ['$compile', '$sce', ($compile, $sce) => {
...
.directive('chart', [ 'responseService', (responseService) => {
  return {
  	scope: {
  		series: "@"
  	},
